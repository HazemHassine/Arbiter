...
The Local Development Environment Agent is structured to enforce strong safety boundaries while orchestrating local operations. It behaves like a small development-focused SRE operator.
