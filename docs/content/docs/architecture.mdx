---
title: System Architecture & Safety Boundaries
description: Explore Arbiter's domain-driven architecture, single-process execution model, Linux /proc and ss correlation layer, and immutable safety boundaries.
---
