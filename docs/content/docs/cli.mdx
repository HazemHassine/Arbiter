---
title: CLI Commands & Terminal Ergonomics
description: Developer-first command-line interface with interactive fzf-style fuzzy selectors, structured JSON outputs, and Starship prompt integration.
---
