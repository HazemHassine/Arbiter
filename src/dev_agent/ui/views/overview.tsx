    ...
    <>
      ...
      <Panel className="hero-card">
        <div className="hero-identity">
          ...
          <div><span className="hero-kicker">Environment observer</span><h2>Local control plane</h2><p>Correlating host processes, Docker, Compose, ports, and project configuration.</p></div>
        </div>
