...
export function AdminView({ refreshKey }: { refreshKey: number }) {
  ...
  return (
    <>
      <PageHeader eyebrow="Arbiter internals" title="Agent administration" description="Process health, API/model usage, event delivery, persistence, and the safety harness." actions={<><StatusBadge value="auto-refreshing" /><Button onClick={() => void overview.refresh()}><RefreshCw /> Refresh</Button></>} />
